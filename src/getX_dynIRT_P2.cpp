...
// // [[Rcpp::export()]]
void getX_dynIRT_P2(arma::mat &Ex,              // NxT: current ideal points for each legislator and time period.
                 ...
                 const arma::mat &omega2,       // N×1: process noise per i (legislator innovation parameter)
                 const arma::mat &Eb,           // J×1: E[β] stacked by time (item parameters stacked by time)
                 const arma::mat &Eystar,       // N×J: E[y*]
                 const arma::mat &Eba,          // J×1: E[β α] stacked by time
                 const arma::mat &startlegis,   // N×1: contiguous legislator first time period
                 const arma::mat &endlegis,     // N×1: contiguous legislator last time period
